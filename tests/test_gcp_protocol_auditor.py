...
import pytest
from gcp_protocol_auditor.models import FrontierPayload, ExecutionStatus
from gcp_protocol_auditor.engine import FrontierDomainEngine
from gcp_protocol_auditor.agents import VisitWindowComplianceAgent, IPAccountabilityAuditorAgent, GCPDeviationClassifierAgent, GCPProtocolCoordinator
from gcp_protocol_auditor.cli import main


def test_sub_agents():
    a1 = VisitWindowComplianceAgent()
    ...
    a2 = IPAccountabilityAuditorAgent()
    ...
    a3 = GCPDeviationClassifierAgent()
...
def test_coordinator():
    ...
    assert "ICH E6(R2) Good Clinical Practice" in ans or "specifications" in ans
