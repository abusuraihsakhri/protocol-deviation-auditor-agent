"""
Data Models & Telemetry Definitions for ICH-GCP Protocol Deviation & Good Clinical Practice Auditor Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "ICH E6(R2) Good Clinical Practice"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
