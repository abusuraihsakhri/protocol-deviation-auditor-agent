"""
FastAPI REST API Server for ICH-GCP Protocol Deviation & Good Clinical Practice Auditor Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="ICH-GCP Protocol Deviation & Good Clinical Practice Auditor Agent",
            description="Audits study visit windows (days), investigational product accountability, and protocol inclusion/exclusion deviations.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "protocol-deviation-auditor-agent", "domain": "Clinical Trials", "version": "2.0.0-FRONTIER"}
