"""
Command Line Interface for Protocol Deviation Auditor Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="protocol-deviation-auditor-agent", description="Protocol Deviation Auditor Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  PROTOCOL DEVIATION AUDITOR AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Protocol Deviation Auditor Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Protocol Deviation Auditor Agent API server on http://{args.host}:{args.port}")
